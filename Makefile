...
CXXFLAGS = -I"C:\Program Files\CodingLibraries\SFML-2.5.1\include" -Iinclude -Wall -std=c++17 # Options de compilation

# Compiler libraries (SFML)
LDFLAGS = -L"C:\Program Files\CodingLibraries\SFML-2.5.1\lib" -lsfml-graphics -lsfml-window -lsfml-audio -lsfml-system # Bibliothèques SFML
